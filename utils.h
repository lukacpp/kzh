...
#define BASE_MUTEX "Global\\BASE-B35DA2E8FD5E"
...
#define OFF_ENGINE_PATTERN                                                                         \
	"\xFF\x15\xFF\xFF\xFF\xFF\x68\xFF\xFF\xFF\xFF\x89\x86\xFF\xFF\xFF\xFF\xFF\x15\xFF\xFF\xFF\xFF" \
	"\x68\xFF\xFF\xFF\xFF\x89\x86\xFF\xFF\xFF\xFF\xFF\x15\xFF\xFF\xFF\xFF\x68\xFF\xFF\xFF\xFF\x89" \
	"\x86\xFF\xFF\xFF\xFF\xFF\x15\xFF\xFF\xFF\xFF\x68\xFF\xFF\xFF\xFF\x89\x86\xFF\xFF\xFF\xFF\xFF" \
	"\x15\xFF\xFF\xFF\xFF\x68\xFF\xFF\xFF\xFF\x89\x86\xFF\xFF\xFF\xFF\xFF\x15\xFF\xFF\xFF\xFF\x68" \
	"\xFF\xFF\xFF\xFF\x89\x86\xFF\xFF\xFF\xFF\xFF\x15\xFF\xFF\xFF\xFF\x68\xFF\xFF\xFF\xFF\x89\x86" \
	"\xFF\xFF\xFF\xFF\xFF\x15\xFF\xFF\xFF\xFF"

#define OFF_ENGINE_MASK                                                                            \
	"xx????x????xx????xx????x????xx????xx????x????xx????xx????x????xx????xx????x????xx????xx????"  \
	"x????xx????xx????x????xx????xx????"

#define OFF_STUDIO_PATTERN "Couldn't get client .dll studio model rendering interface."

#define OFF_SVC_MSG_PATTERN                                                                        \
	"\xBF\xFF\xFF\xFF\xFF\x8B\x04\xB5\xFF\xFF\xFF\xFF\x85\xC0\x74\xFF\x81\xFF\xFF\xFF\xFF\xFF\x7F" \
	"\x04\x8B\x0F\xEB\x05"
